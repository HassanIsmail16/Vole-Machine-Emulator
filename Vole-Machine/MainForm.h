...
namespace VoleMachine {
	...
	public:
		...
		MainForm(void) {
			...
			this->memoryController = gcnew MemoryController(this->machine);
...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void) {
			...
			this->third_operand_textbox->Size = System::Drawing::Size(35, 22);
			...
			this->second_operand_textbox->Size = System::Drawing::Size(35, 22);
			...
			this->first_operand_textbox->Size = System::Drawing::Size(35, 22);
			...
			this->opcode_textbox->Size = System::Drawing::Size(35, 22);
			...
			this->current_instruction_textbox->Size = System::Drawing::Size(160, 22);
			...
			this->current_address_textbox->Size = System::Drawing::Size(201, 22);
			...
			// fetch
			// 
			this->fetch->Location = System::Drawing::Point(373, 26);
			this->fetch->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			this->fetch->Name = L"fetch";
			this->fetch->Size = System::Drawing::Size(131, 28);
